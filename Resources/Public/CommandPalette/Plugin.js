...
var CommandPalette = (_dec = (0, _reactRedux.connect)((0, _plowJs.$transform)({
    ...
    _inherits(CommandPalette, _PureComponent);

    function CommandPalette(props) {
        _classCallCheck(this, CommandPalette);

        var _this = _possibleConstructorReturn(this, (CommandPalette.__proto__ || Object.getPrototypeOf(CommandPalette)).call(this, props));
